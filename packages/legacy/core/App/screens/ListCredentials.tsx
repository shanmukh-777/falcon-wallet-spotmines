        ...
        credentials.length === 0
          ...
          <View style={{display:'flex',width:'100%',height:'100%'}} >
                        ...
                        <View  style={{height:'100%',display:'flex',alignItems:'center',paddingTop:'2%'}}>
                            ...
                            <Text style={{ fontSize: getFontSizel(),width:'80%',alignSelf:'center',color:'#8E8E8E' }}>Scan QR code to contact trusted issuers to own your verifiable credentials.</Text>
                        </View>
                    </View>
          :
