...
const RootStack: React.FC = () => {
  ...
  const mainStack = () => {
    ...
    return (
      // <Stack.Navigator initialRouteName={Screens.Splash} screenOptions={{ ...defaultStackOptions, headerShown: false }}>
      //   <Stack.Screen name={Screens.Splash} component={splash} />
      <Stack.Navigator initialRouteName={Screens.WalletAnimationScreen} screenOptions={{ ...defaultStackOptions, headerShown: false }}>
      <Stack.Screen name={Screens.WalletAnimationScreen} component={WalletAnimationScreen} />
        <Stack.Screen name={Stacks.TabStack} component={TabStack} options={() => ({
            headerShown: false
          })}/>
        <Stack.Screen
          name={Screens.Chat}
  ...
  const onboardingStack = () => {
    ...
    return (
      <Stack.Navigator initialRouteName={Screens.falcon} screenOptions={{ ...defaultStackOptions, headerShown: false }}>
        <Stack.Screen name={Screens.falcon} component={falcon} />
        <Stack.Screen
        ...
        <Stack.Screen
          name={Screens.GeoLocationScreen}
          options={() => ({
