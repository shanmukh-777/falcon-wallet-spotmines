...
import { Screens, Stacks, TabStackParams, TabStacks, HomeStackParams, ConnectStackParams, RootStackParams, AuthenticateStackParams } from './../../types/navigators';
    ...
    return (
        <View style={{ position: 'absolute', bottom: 0, width: '100%', backgroundColor: 'white' }}>
            {!keyboardStatus ? (
                ...
                <View style={{ padding: 0, height: 0, backgroundColor: 'green' }}>
