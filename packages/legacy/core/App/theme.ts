...
const BrandColors: IBrandColors = {
  ...
  secondary: '#313132',
  secondaryDisabled: 'rgba(53, 130, 63, ${heavyOpacity})',
  primaryLight: '#FFFFFF', // Adjusted to white
  highlight: '#FCBA19',
  primaryBackground: '#FFFFFF', // Adjusted to white
  secondaryBackground: '#F2F2F2', // Adjusted to very light grey
  modalPrimary: '#42803E',
  modalSecondary: '#313132',
  modalPrimaryBackground: '#FFFFFF', // Adjusted to white
  modalSecondaryBackground: '#F2F2F2', // Adjusted to very light grey
  modalIcon: GrayscaleColors.black, // Adjusted to black
  unorderedList: GrayscaleColors.black, // Adjusted to black
  unorderedListModal: GrayscaleColors.black, // Adjusted to black
  link: '#42803E', // Adjusted to primary color
  text: GrayscaleColors.black, // Adjusted to black
  icon: GrayscaleColors.black, // Adjusted to black
  headerIcon: GrayscaleColors.black, // Adjusted to black
  headerText: GrayscaleColors.black, // Adjusted to black
  buttonText: '#FFFFFF', // Adjusted to white
  tabBarInactive: '#D3D3D3', // Adjusted to light grey
}
